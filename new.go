...
func CreateToken(userid uint64) (*TokenDetails, error) {
	...
	os.Setenv("ACCESS_SECRET", "eyJleHAiOjE1OTgyMTQ1ODksInVzZXJfaWQiOjF9") //this should be in an env file
	...
	os.Setenv("REFRESH_SECRET", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9") //this should be in an env file
